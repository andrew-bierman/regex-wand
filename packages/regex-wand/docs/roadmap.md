...
| P1 | Vite/host fixture for `regex-wand/transform` | The plugin is tested through unplugin's raw Rollup-style hook and the esbuild host adapter. | Add a Vite-specific fixture if Vite users report host-specific behavior. |
